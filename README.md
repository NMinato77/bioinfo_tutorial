...
1. item1 how to manipulate scRNA-seq data with Python
2. item2 pre-process and visualization
3. item3 clustering and dimentinality reduction
4. item4 trajectory inference

Before beginning the tutorial, please set up your envirionment.  
1. item1 Install Python (> ver. 3.6)
2. item2 Install the following libraries  
